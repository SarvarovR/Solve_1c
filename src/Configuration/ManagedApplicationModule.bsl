...
//вводит пользователь, все цифры и двойные пробелы
	...
	Для НомерСимвола = 1 По СтрДлина(ДанныеПользователя) Цикл
		...
		ИначеЕсли СтрНайти(ЧислаИЗнаки, Сред(ДанныеПользователя, НомерСимвола, 1)) = 0 Тогда
			...
			Если Сред(ДанныеПользователя, НомерСимвола, 1) = " " И  (СтрДлина(ДанныеПользователя) - 1) = " " 
			И (НомерСимвола > 1 И НомерСимвола <> СтрДлина(ДанныеПользователя) - 1)  
			ИЛИ (Сред(ДанныеПользователя, НомерСимвола, 1) = " " И (НомерСимвола -1) = 0) Тогда 
